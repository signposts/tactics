This folder contains ping results for tactics: iodine, ssh_tap, ssh_tun, openvpn and also compared with "when no tactic" is used. The ping is done from server to both the clients.

s_c1 indicates ping from server to Client1
s_c2 indicates ping from server to client2.
